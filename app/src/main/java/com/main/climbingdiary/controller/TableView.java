...
public class TableView {
    ...
    public TableView(Context _context, View _view) {
        ...
        this.view = _view;
        this.tableScrollView = view.findViewById(R.id.TableScrollView);
    }
